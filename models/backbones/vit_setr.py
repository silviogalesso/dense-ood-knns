# Adapted from https://github.com/fudan-zvg/SETR/blob/main/mmseg/models/backbones/vit.py
# Added resampling of positional embedding
...
class VisionTransformerSETR(nn.Module):
    ...
    def __init__(self, model_name='vit_large_patch16_384', img_size=384, patch_size=16, in_chans=3, embed_dim=1024, depth=24,
                 ...
                 pos_embed_interp=False, init_cfg=None, align_corners=False, **kwargs):
        super(VisionTransformerSETR, self).__init__(**kwargs)
        ...
        assert init_cfg is None, "Not implemented!"
    ...
    def forward(self, x):
        ...
        x = x + self.resize_pos_embed(self.pos_embed, (h, w), (self.img_size[0]//self.patch_size, self.img_size[1]//self.patch_size), 'bicubic')
        x = self.pos_drop(x)
        ...
        for i, blk in enumerate(self.blocks):
            ...
            if i in self.out_indices:
                outs.append(x[:,1:].transpose(1, 2).reshape(B, -1, h, w))
        return tuple(outs)
